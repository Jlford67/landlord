...
INSERT INTO "new_Property" ("baths", "beds", "city", "createdAt", "doors", "id", "nickname", "notes", "redfinEstimatedValue", "redfinEstimatedValueUpdatedAt", "redfinUrl", "sqFt", "state", "status", "street", "zillowEstimatedValue", "zillowEstimatedValueUpdatedAt", "zillowUrl", "zip") SELECT "baths", "beds", "city", "createdAt", "doors", "id", "nickname", "notes", "redfinEstimatedValue", "redfinEstimatedValueUpdatedAt", "redfinUrl", "sqFt", "state", "status", "street", "zillowEstimatedValue", "zillowEstimatedValueUpdatedAt", "zillowUrl", "zip" FROM "Property";
DROP TABLE "Property";
